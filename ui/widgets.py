from PyQt5.QtWidgets import QWidget, QLabel, QVBoxLayout, QHBoxLayout, QLineEdit, QSpinBox, QDoubleSpinBox, QCheckBox, QComboBox
...
class ParameterInput(QWidget):
    def __init__(self, label_text, widget_type, default_value=None, options=None, parent=None):
